 ...
 */
     ...
     */ 
         ...
         * 
         *
         * @see \App\Providers\ResponseMacroServiceProvider::register()
         * @param mixed $xml
         * @param mixed $status
         * @param array $header
         * @static 
         */ 
        public static function atom($xml, $status = 200, $header = [])
        {
                        return \Illuminate\Routing\ResponseFactory::atom($xml, $status, $header);
        }
